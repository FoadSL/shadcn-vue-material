 ...
 * custom/registry/new-york-v4/ui so scripts become valid JS:
 ...
 *
 * This is a heuristic pass but keeps templates and normal imports intact.
 */
...
const uiRoot = path.join(rootDir, 'custom', 'registry', 'new-york-v4', 'ui')
...
async function main() {
  console.log('Stripping TS syntax from Vue SFCs in ui/ ...')
  ...
  console.log('Done stripping TS from ui/ components.')
}
